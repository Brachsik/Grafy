...
from src.api.prj6.algorithms import page_rank, simulated_annealing, circuit_length, number_to_alpha
...
def alpha_to_adjacency_list(l):
    ...
    l = re.sub(r":(.*)", r":{\g<1>},\n", l) # tutaj tak zrby dzialal dla ostatniego jak jest wiecej jak jeden
    print("\n")
    print(l)
    l = re.sub(r"\s", "", l)
